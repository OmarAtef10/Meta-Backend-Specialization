...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\jetbrains\python projects\Meta Course\APIs_Course\Project\LittleLemon'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\jetbrains\python projects\Meta Course\APIs_Course\Project\LittleLemon\Scripts\deactivate.nu'
